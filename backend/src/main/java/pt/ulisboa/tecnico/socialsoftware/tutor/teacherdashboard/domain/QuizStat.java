...
@Entity
public class QuizStat implements DomainEntity {
    ...
    public QuizStat(CourseExecution courseExecution, TeacherDashboard teacherDashboard) {
        setTeacherDashboard(teacherDashboard);
        setCourseExecution(courseExecution);
    }

    public void remove() {
        teacherDashboard.getQuizStat().remove(this);
